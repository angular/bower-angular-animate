...
"ng-move",f.element(h(a)),d,c,p,e,k)})},addClass:function(a,d,c){return this.setClass(a,d,[],c)},removeClass:function(a,d,c){return this.setClass(a,[],d,c)},setClass:function(a,d,c,e){e=Q(e);a=f.element(a);a=f.element(h(a));if(x(a))return N.$$setClassImmediately(a,d,c);var n,g=a.data("$$animateClasses"),l=!!g;g||(g={classes:{}});n=g.classes;d=D(d)?d:d.split(" ");k(d,function(b){b&&b.length&&(n[b]=!0)});c=D(c)?c:c.split(" ");k(c,function(b){b&&b.length&&(n[b]=!1)});if(l)return e&&g.options&&(g.options=
g.options.concat(e)),g.promise;a.data("$$animateClasses",g={classes:n,options:e});return g.promise=P(function(b){var c=a.parent(),d=h(a),l=d.parentNode;if(!l||l.$$NG_REMOVED||d.$$NG_REMOVED)b();else{d=a.data("$$animateClasses");a.removeData("$$animateClasses");var l=a.data("$$ngAnimateState")||{},e=R(a,d,l.active);return e?G("setClass",e,a,c,null,function(){e[0]&&N.$$addClassImmediately(a,e[0]);e[1]&&N.$$removeClassImmediately(a,e[1])},d.options,b):b()}})},cancel:function(a){a.$$cancelFn()},enabled:function(a,
d){switch(arguments.length){case 2:if(a)B(d);else{var c=d.data("$$ngAnimateState")||{};c.disabled=!0;d.data("$$ngAnimateState",c)}break;case 1:t.disabled=!a;break;default:a=!t.disabled}return!!a}}}]);C.register("",["$window","$sniffer","$timeout","$$animateReflow",function(t,C,K,W){function u(){c||(c=W(function(){d=[];c=null;A={}}))}function y(a,b){c&&c();d.push(b);c=W(function(){k(d,function(b){b()});d=[];c=null;A={}})}function O(a,b){var c=h(a);a=f.element(c);g.push(a);c=Date.now()+b;c<=M||(K.cancel(e),
M=c,e=K(function(){V(g);g=[]},b,!1))}function V(a){k(a,function(b){(b=b.data("$$ngAnimateCSS3Data"))&&k(b.closeAnimationFns,function(b){b()})})}function X(a,b){var c=b?A[b]:null;if(!c){var d=0,e=0,f=0,h=0;k(a,function(b){if(1==b.nodeType){b=t.getComputedStyle(b)||{};d=Math.max(x(b[J+"Duration"]),d);e=Math.max(x(b[J+"Delay"]),e);h=Math.max(x(b[H+"Delay"]),h);var a=x(b[H+"Duration"]);0<a&&(a*=parseInt(b[H+"IterationCount"],10)||1);f=Math.max(a,f)}});c={total:0,transitionDelay:e,transitionDuration:d,
animationDelay:h,animationDuration:f};b&&(A[b]=c)}return c}function x(a){var b=0;a=ba(a)?a.split(/\s*,\s*/):[];k(a,function(a){b=Math.max(parseFloat(a)||0,b)});return b}function P(c,b,d){c=0<=["ng-enter","ng-leave","ng-move"].indexOf(d);var e,f=b.parent(),k=f.data("$$ngAnimateKey");k||(f.data("$$ngAnimateKey",++a),k=a);e=k+"-"+h(b).getAttribute("class");var f=e+" "+d,k=A[f]?++A[f].total:0,g={};if(0<k){var m=d+"-stagger",g=e+" "+m;(e=!A[g])&&b.addClass(m);g=X(b,g);e&&b.removeClass(m)}b.addClass(d);
var m=b.data("$$ngAnimateCSS3Data")||{},r=X(b,f);e=r.transitionDuration;r=r.animationDuration;if(c&&0===e&&0===r)return b.removeClass(d),!1;d=c&&0<e;c=0<r&&0<g.animationDelay&&0===g.animationDuration;b.data("$$ngAnimateCSS3Data",{stagger:g,cacheKey:f,running:m.running||0,itemIndex:k,blockTransition:d,closeAnimationFns:m.closeAnimationFns||[]});b=h(b);d&&(b.style[J+"Property"]="none");c&&(b.style[H+"PlayState"]="paused");return!0}function Q(a,b,c,d){function e(){b.off(D,f);b.removeClass(m);b.removeClass(r);
y&&K.cancel(y);G(b,c);var a=h(b),d;for(d in n)a.style.removeProperty(n[d])}function f(b){b.stopPropagation();var a=b.originalEvent||b;b=a.$manualTimeStamp||a.timeStamp||Date.now();a=parseFloat(a.elapsedTime.toFixed(3));Math.max(b-C,0)>=A&&a>=x&&d()}var g=h(b);a=b.data("$$ngAnimateCSS3Data");if(-1!=g.getAttribute("class").indexOf(c)&&a){a.blockTransition&&(g.style[J+"Property"]="");var m="",r="";k(c.split(" "),function(b,a){var c=(0<a?" ":"")+b;m+=c+"-active";r+=c+"-pending"});var n=[],q=a.itemIndex,
v=a.stagger,p=0;if(0<q){p=0;0<v.transitionDelay&&0===v.transitionDuration&&(p=v.transitionDelay*q);var t=0;0<v.animationDelay&&0===v.animationDuration&&(t=v.animationDelay*q,n.push(B+"animation-play-state"));p=Math.round(100*Math.max(p,t))/100}p||b.addClass(m);var u=X(b,a.cacheKey+" "+m),x=Math.max(u.transitionDuration,u.animationDuration);if(0===x)b.removeClass(m),G(b,c),d();else{var q=Math.max(u.transitionDelay,u.animationDelay),A=1E3*q;0<n.length&&(v=g.getAttribute("style")||"",";"!==v.charAt(v.length-
1)&&(v+=";"),g.setAttribute("style",v+" "));var C=Date.now(),D=T+" "+Z,q=1E3*(p+1.5*(q+x)),y;0<p&&(b.addClass(r),y=K(function(){y=null;b.addClass(m);b.removeClass(r);0<u.animationDuration&&(g.style[H+"PlayState"]="")},1E3*p,!1));b.on(D,f);a.closeAnimationFns.push(function(){e();d()});a.running++;O(b,q);return e}}else d()}function R(a,b,c,d){if(P(a,b,c,d))return function(a){a&&G(b,c)}}function S(a,b,c,d){if(b.data("$$ngAnimateCSS3Data"))return Q(a,b,c,d);G(b,c);d()}function Y(a,b,c,d){var e=R(a,b,
c);if(e){var f=e;y(b,function(){f=S(a,b,c,d)});return function(a){(f||p)(a)}}u();d()}function G(a,b){a.removeClass(b);var c=a.data("$$ngAnimateCSS3Data");c&&(c.running&&c.running--,c.running&&0!==c.running||a.removeData("$$ngAnimateCSS3Data"))}function n(a,b){var c="";a=D(a)?a:a.split(/\s+/);k(a,function(a,d){a&&0<a.length&&(c+=(0<d?" ":"")+a+b)});return c}var B="",J,Z,H,T;L.ontransitionend===U&&L.onwebkittransitionend!==U?(B="-webkit-",J="WebkitTransition",Z="webkitTransitionEnd transitionend"):
(J="transition",Z="transitionend");L.onanimationend===U&&L.onwebkitanimationend!==U?(B="-webkit-",H="WebkitAnimation",T="webkitAnimationEnd animationend"):(H="animation",T="animationend");var A={},a=0,d=[],c,e=null,M=0,g=[];return{enter:function(a,b){return Y("enter",a,"ng-enter",b)},leave:function(a,b){return Y("leave",a,"ng-leave",b)},move:function(a,b){return Y("move",a,"ng-move",b)},beforeSetClass:function(a,b,c,d){b=n(c,"-remove")+" "+n(b,"-add");if(b=R("setClass",a,b))return y(a,d),b;u();d()},
beforeAddClass:function(a,b,c){if(b=R("addClass",a,n(b,"-add")))return y(a,c),b;u();c()},beforeRemoveClass:function(a,b,c){if(b=R("removeClass",a,n(b,"-remove")))return y(a,c),b;u();c()},setClass:function(a,b,c,d){c=n(c,"-remove");b=n(b,"-add");return S("setClass",a,c+" "+b,d)},addClass:function(a,b,c){return S("addClass",a,n(b,"-add"),c)},removeClass:function(a,b,c){return S("removeClass",a,n(b,"-remove"),c)}}}])}])})(window,window.angular);
