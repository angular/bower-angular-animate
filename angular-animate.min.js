...
(k.style[d+W]="");a.blockAnimation&&(k.style[e]="");var n="";g(G.split(" "),function(a,b){n+=(0<b?" ":"")+a+"-active"});u.addClass(n);var r=S(u,a.cacheKey+" "+n),t=Math.max(r.transitionDuration,r.animationDuration);if(0===t)u.removeClass(n),M(u,G),w();else{var y=Math.max(r.transitionDelay,r.animationDelay),s=a.stagger,x=a.itemIndex,B=y*C,q="",v=[];if(0<r.transitionDuration){var A=r.transitionPropertyStyle;-1==A.indexOf("all")&&(q+=b+"transition-property: "+A+";",q+=b+"transition-duration: "+r.transitionDurationStyle+
";",v.push(b+"transition-property"),v.push(b+"transition-duration"))}0<x&&(0<s.transitionDelay&&0===s.transitionDuration&&(q+=b+"transition-delay: "+z(r.transitionDelayStyle,s.transitionDelay,x)+"; ",v.push(b+"transition-delay")),0<s.animationDelay&&0===s.animationDuration&&(q+=b+"animation-delay: "+z(r.animationDelayStyle,s.animationDelay,x)+"; ",v.push(b+"animation-delay")));0<v.length&&(r=k.getAttribute("style")||"",k.setAttribute("style",r+"; "+q));var E=Date.now(),F=H+" "+c;u.on(F,m);a.closeAnimationFn=
function(){f();w()};k=(x*(Math.max(s.animationDelay,s.transitionDelay)||0)+(y+t)*l)*C;a.running++;I(u,k);return f}}else w()}function z(a,b,c){var d="";g(a.split(","),function(a,e){d+=(0<e?",":"")+(c*b+parseInt(a,10))+"s"});return d}function N(a,b,c,d){if(q(a,b,c,d))return function(a){a&&M(b,c)}}function O(a,b,c,d){if(b.data(p))return T(a,b,c,d);M(b,c);d()}function P(a,b,c,d){var e=N(a,b,c);if(e){var f=e;F(b,function(){f=O(a,b,c,d)});return function(a){(f||t)(a)}}d()}function M(a,b){a.removeClass(b);
var c=a.data(p);c&&(c.running&&c.running--,c.running&&0!==c.running||a.removeData(p))}function a(a,b){var c="";a=f.isArray(a)?a:a.split(/\s+/);g(a,function(a,d){a&&0<a.length&&(c+=(0<d?" ":"")+a+b)});return c}var b="",d,c,e,H;s.ontransitionend===Q&&s.onwebkittransitionend!==Q?(b="-webkit-",d="WebkitTransition",c="webkitTransitionEnd transitionend"):(d="transition",c="transitionend");s.onanimationend===Q&&s.onwebkitanimationend!==Q?(b="-webkit-",e="WebkitAnimation",H="webkitAnimationEnd animationend"):
(e="animation",H="animationend");var R="Duration",W="Property",y="Delay",B="IterationCount",ba="$$ngAnimateKey",p="$$ngAnimateCSS3Data",D=3,l=1.5,C=1E3,k={},A=0,U=[],v,$=null,aa=0,V=[];return{enter:function(a,b){return P("enter",a,"ng-enter",b)},leave:function(a,b){return P("leave",a,"ng-leave",b)},move:function(a,b){return P("move",a,"ng-move",b)},beforeSetClass:function(b,c,d,e){c=a(d,"-remove")+" "+a(c,"-add");if(c=N("setClass",b,c))return F(b,e),c;e()},beforeAddClass:function(b,c,d){if(c=N("addClass",
b,a(c,"-add")))return F(b,d),c;d()},beforeRemoveClass:function(b,c,d){if(c=N("removeClass",b,a(c,"-remove")))return F(b,d),c;d()},setClass:function(b,c,d,e){d=a(d,"-remove");c=a(c,"-add");return O("setClass",b,d+" "+c,e)},addClass:function(b,c,d){return O("addClass",b,a(c,"-add"),d)},removeClass:function(b,c,d){return O("removeClass",b,a(c,"-remove"),d)}}}])}])})(window,window.angular);
